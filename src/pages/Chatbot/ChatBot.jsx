...
const ChatBot = () => {
  ...
  return (
    <div className="p-4 max-w-lg mx-auto bg-gray-900 text-gray-100 border border-gray-700 rounded-lg shadow-lg">
      <h2 className="text-xl font-bold mb-4 text-white">🤖 Gemini ChatBot</h2>
