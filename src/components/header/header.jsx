...
export default function Header({ onToggleSidebar }) {
  return (
    <header className="backdrop-blur-3xl border-b border-[#1C1D20] px-4 py-3 sm:px-6 sm:py-4 z-50 flex flex-wrap items-center justify-between gap-4 sm:gap-0">
      ...
      <div className="flex flex-wrap max-sm:w-full sm:items-center sm:space-x-4 justify-end sm:justify-end gap-4 sm:gap-4">
        ...
        <div className="relative max-sm:w-full sm:w-auto flex-1 sm:flex-none">
          ...
          <input
            ...
            className="border border-[#1C1D20] rounded-[30px] pl-10 pr-4 py-2 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full sm:w-64"
          />
